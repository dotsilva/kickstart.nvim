...
require('lazy').setup({
  ...
  -- NOTE: here was git signs, something to add to the "gutter".
  ...
  -- NOTE: this was the place of which-key.
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- ==== ADD THIS BLOCK: Route LSP navigation through mini.pick ====
          local pick_lsp = function(scope)
            return function() require('mini.extra').pickers.lsp { scope = scope } end
          end

          map('grr', pick_lsp 'references', '[G]oto [R]eferences')
          map('gri', pick_lsp 'implementation', '[G]oto [I]mplementation')
          map('grd', pick_lsp 'definition', '[G]oto [D]efinition')
  ...
  -- NOTE: here was todocomments plugin
