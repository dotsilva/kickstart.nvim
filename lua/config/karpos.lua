...
hi('MiniClueNextKey', { fg = p.magenta, bold = true })

-- Mini Indentscope
hi('MiniIndentscopeSymbol', { fg = p.bg1 })
...
hi('BlinkCmpMenuSelection', { fg = p.bg0, bg = p.black, bold = true })
...
-- DAP & Neotest
hi('DapBreakpoint', { fg = p.red, bg = p.bg0 })
hi('DapStopped', { fg = p.yellow, bg = p.bg0 })
